...
public class TimelineServer {
	...
	public static void main(String[] args) {
		...
		ipAddress("0.0.0.0");
		get("/", TimelineServer::randomMovieEndpoint);
		get("/ready", TimelineServer::readyEndpoint);
		get("/credits", TimelineServer::creditsEndpoint);
		get("/movies", TimelineServer::moviesEndpoint);
		get("/old-movies", TimelineServer::oldMoviesEndpoint);
		get("/stats", TimelineServer::statsEndpoint);
